...
@Component({
  ...
  selector: 'home-cruces-general-chart',
  templateUrl: './cruces-general-chart.component.html',
  styleUrls: ['./cruces-general-chart.component.scss'],
})
export class CrucesGeneralChartComponent implements OnInit, AfterViewInit {
