...
@Component({
  ...
  selector: 'home-cruces-chart',
  templateUrl: './cruces-chart.component.html',
  styleUrls: ['./cruces-chart.component.scss'],
})
export class CrucesChartComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  ngOnInit() {
    ...
    console.log('this.InChartData', this.InChartData);
    setTimeout(() => {
